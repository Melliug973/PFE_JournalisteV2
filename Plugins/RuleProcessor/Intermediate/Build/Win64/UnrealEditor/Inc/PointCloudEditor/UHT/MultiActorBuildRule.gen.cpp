...
template<> POINTCLOUDEDITOR_API UScriptStruct* StaticStruct<FMultiActorBuildRuleData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_MultiActorBuildRule_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_MultiActorBuildRule_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_MultiActorBuildRule_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_MultiActorBuildRule_h_508369641(TEXT("/Script/PointCloudEditor"),
		Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_MultiActorBuildRule_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_MultiActorBuildRule_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_MultiActorBuildRule_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_MultiActorBuildRule_h_Statics::ScriptStructInfo),
		nullptr, 0);
