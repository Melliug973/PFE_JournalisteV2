...
template<> POINTCLOUDEDITOR_API UScriptStruct* StaticStruct<FSpawnNiagaraRuleData>()
{
	...
	struct Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_2657663099(TEXT("/Script/PointCloudEditor"),
		Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloudEditor_Private_Rules_SpawnNiagaraRule_h_Statics::EnumInfo));
