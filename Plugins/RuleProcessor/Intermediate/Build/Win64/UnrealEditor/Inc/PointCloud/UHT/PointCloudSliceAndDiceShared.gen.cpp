...
template<> POINTCLOUD_API UScriptStruct* StaticStruct<FSliceAndDiceManagedActorsEntry>()
{
	...
	struct Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceShared_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceShared_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceShared_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceShared_h_1478884625(TEXT("/Script/PointCloud"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceShared_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceShared_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceShared_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceShared_h_Statics::EnumInfo));
