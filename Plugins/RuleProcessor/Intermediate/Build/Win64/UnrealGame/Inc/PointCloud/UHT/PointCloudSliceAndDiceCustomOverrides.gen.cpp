...
template<> POINTCLOUD_API UScriptStruct* StaticStruct<FCustomOverrides>()
{
	...
	struct Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceCustomOverrides_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceCustomOverrides_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceCustomOverrides_h_868892925(TEXT("/Script/PointCloud"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceCustomOverrides_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_RuleProcessor_Source_PointCloud_Public_PointCloudSliceAndDiceCustomOverrides_h_Statics::ScriptStructInfo),
		nullptr, 0);
