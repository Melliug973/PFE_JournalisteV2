...
template<> MASSTRAFFIC_API UScriptStruct* StaticStruct<FZoneGraphTrafficLaneData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTypes_h_3763593101(TEXT("/Script/MassTraffic"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
