...
template<> MASSTRAFFICEDITOR_API UScriptStruct* StaticStruct<FMassTrafficPointHints>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderTypes_h_3967102232(TEXT("/Script/MassTrafficEditor"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_jules_Unreal_Projects_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTrafficEditor_Public_MassTrafficBuilderTypes_h_Statics::EnumInfo));
