...
template<> MASSTRAFFIC_API UScriptStruct* StaticStruct<FMassTrafficDriversParameters>()
{
	...
	struct Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_1738657202(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficDrivers_h_Statics::EnumInfo));
