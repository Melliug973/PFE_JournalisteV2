...
#include "MassTraffic/Public/MassTrafficPostPhysicsUpdateTrailersProcessor.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMassTrafficPostPhysicsUpdateTrailersProcessor);
	UClass* Z_Construct_UClass_UMassTrafficPostPhysicsUpdateTrailersProcessor_NoRegister()
	{
		return UMassTrafficPostPhysicsUpdateTrailersProcessor::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficPostPhysicsUpdateTrailersProcessor_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficPostPhysicsUpdateTrailersProcessor_Statics::StaticCppClassTypeInfo = {
	...
	template<> MASSTRAFFIC_API UClass* StaticClass<UMassTrafficPostPhysicsUpdateTrailersProcessor>()
	{
		return UMassTrafficPostPhysicsUpdateTrailersProcessor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMassTrafficPostPhysicsUpdateTrailersProcessor);
	UMassTrafficPostPhysicsUpdateTrailersProcessor::~UMassTrafficPostPhysicsUpdateTrailersProcessor() {}
	struct Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrailersProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrailersProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficPostPhysicsUpdateTrailersProcessor, UMassTrafficPostPhysicsUpdateTrailersProcessor::StaticClass, TEXT("UMassTrafficPostPhysicsUpdateTrailersProcessor"), &Z_Registration_Info_UClass_UMassTrafficPostPhysicsUpdateTrailersProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficPostPhysicsUpdateTrailersProcessor), 3842761516U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrailersProcessor_h_2186091746(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrailersProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrailersProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
