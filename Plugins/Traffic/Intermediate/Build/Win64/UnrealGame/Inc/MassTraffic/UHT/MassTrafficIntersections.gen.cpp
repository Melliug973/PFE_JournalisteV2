...
template<> MASSTRAFFIC_API UScriptStruct* StaticStruct<FMassTrafficIntersectionDetail>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h_2697936001(TEXT("/Script/MassTraffic"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficIntersections_h_Statics::ScriptStructInfo),
		nullptr, 0);
