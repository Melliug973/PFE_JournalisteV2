...
#include "MassTraffic/Public/MassTrafficVehicleVisualizationLODProcessor.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMassTrafficVehicleVisualizationLODProcessor);
	UClass* Z_Construct_UClass_UMassTrafficVehicleVisualizationLODProcessor_NoRegister()
	{
		return UMassTrafficVehicleVisualizationLODProcessor::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficVehicleVisualizationLODProcessor_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficVehicleVisualizationLODProcessor_Statics::StaticCppClassTypeInfo = {
	...
	template<> MASSTRAFFIC_API UClass* StaticClass<UMassTrafficVehicleVisualizationLODProcessor>()
	{
		return UMassTrafficVehicleVisualizationLODProcessor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMassTrafficVehicleVisualizationLODProcessor);
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMassTrafficVehicleLODCollectorProcessor);
	UClass* Z_Construct_UClass_UMassTrafficVehicleLODCollectorProcessor_NoRegister()
	{
		return UMassTrafficVehicleLODCollectorProcessor::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficVehicleLODCollectorProcessor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "MassTrafficVehicleVisualizationLODProcessor.h" },
		{ "ModuleRelativePath", "Public/MassTrafficVehicleVisualizationLODProcessor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficVehicleLODCollectorProcessor_Statics::StaticCppClassTypeInfo = {
	...
	template<> MASSTRAFFIC_API UClass* StaticClass<UMassTrafficVehicleLODCollectorProcessor>()
	{
		return UMassTrafficVehicleLODCollectorProcessor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMassTrafficVehicleLODCollectorProcessor);
	UMassTrafficVehicleLODCollectorProcessor::~UMassTrafficVehicleLODCollectorProcessor() {}
	struct Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationLODProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationLODProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficVehicleVisualizationLODProcessor, UMassTrafficVehicleVisualizationLODProcessor::StaticClass, TEXT("UMassTrafficVehicleVisualizationLODProcessor"), &Z_Registration_Info_UClass_UMassTrafficVehicleVisualizationLODProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficVehicleVisualizationLODProcessor), 2136887523U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationLODProcessor_h_1556695645(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationLODProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficVehicleVisualizationLODProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
