...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficPostPhysicsUpdateTrafficVehiclesProcessor_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficPostPhysicsUpdateTrafficVehiclesProcessor_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrafficVehiclesProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrafficVehiclesProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficPostPhysicsUpdateTrafficVehiclesProcessor, UMassTrafficPostPhysicsUpdateTrafficVehiclesProcessor::StaticClass, TEXT("UMassTrafficPostPhysicsUpdateTrafficVehiclesProcessor"), &Z_Registration_Info_UClass_UMassTrafficPostPhysicsUpdateTrafficVehiclesProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficPostPhysicsUpdateTrafficVehiclesProcessor), 3413040787U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrafficVehiclesProcessor_h_1337941165(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrafficVehiclesProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficPostPhysicsUpdateTrafficVehiclesProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
