...
#include "MassTraffic/Public/MassTrafficInitTrafficVehicleSpeedProcessor.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMassTrafficInitTrafficVehicleSpeedProcessor);
	UClass* Z_Construct_UClass_UMassTrafficInitTrafficVehicleSpeedProcessor_NoRegister()
	{
		return UMassTrafficInitTrafficVehicleSpeedProcessor::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassTrafficInitTrafficVehicleSpeedProcessor_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMassTrafficInitTrafficVehicleSpeedProcessor_Statics::StaticCppClassTypeInfo = {
	...
	template<> MASSTRAFFIC_API UClass* StaticClass<UMassTrafficInitTrafficVehicleSpeedProcessor>()
	{
		return UMassTrafficInitTrafficVehicleSpeedProcessor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMassTrafficInitTrafficVehicleSpeedProcessor);
	UMassTrafficInitTrafficVehicleSpeedProcessor::~UMassTrafficInitTrafficVehicleSpeedProcessor() {}
	struct Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitTrafficVehicleSpeedProcessor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitTrafficVehicleSpeedProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTrafficInitTrafficVehicleSpeedProcessor, UMassTrafficInitTrafficVehicleSpeedProcessor::StaticClass, TEXT("UMassTrafficInitTrafficVehicleSpeedProcessor"), &Z_Registration_Info_UClass_UMassTrafficInitTrafficVehicleSpeedProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTrafficInitTrafficVehicleSpeedProcessor), 3964114637U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitTrafficVehicleSpeedProcessor_h_3364264886(TEXT("/Script/MassTraffic"),
		Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitTrafficVehicleSpeedProcessor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_Traffic_Source_MassTraffic_Public_MassTrafficInitTrafficVehicleSpeedProcessor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
