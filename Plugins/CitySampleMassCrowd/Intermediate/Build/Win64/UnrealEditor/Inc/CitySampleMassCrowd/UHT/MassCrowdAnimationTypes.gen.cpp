...
template<> CITYSAMPLEMASSCROWD_API UScriptStruct* StaticStruct<FCrowdAnimationFragment>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_MassCrowdAnimationTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_MassCrowdAnimationTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_MassCrowdAnimationTypes_h_3044549765(TEXT("/Script/CitySampleMassCrowd"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_MassCrowdAnimationTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_paull_OneDrive_Documents_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_MassCrowdAnimationTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
