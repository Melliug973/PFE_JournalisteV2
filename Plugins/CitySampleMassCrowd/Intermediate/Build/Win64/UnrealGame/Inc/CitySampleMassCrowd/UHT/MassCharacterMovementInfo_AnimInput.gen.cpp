...
template<> CITYSAMPLEMASSCROWD_API UScriptStruct* StaticStruct<FMassCharacterMovementInfo_AnimInput>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_Animation_MassCharacterMovementInfo_AnimInput_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_Animation_MassCharacterMovementInfo_AnimInput_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_Animation_MassCharacterMovementInfo_AnimInput_h_1276484304(TEXT("/Script/CitySampleMassCrowd"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_Animation_MassCharacterMovementInfo_AnimInput_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_steuh_OneDrive_Bureau_Project_PFE_PFE_Journalisme_PFE_JournalisteV2_Plugins_CitySampleMassCrowd_Source_CitySampleMassCrowd_Public_Animation_MassCharacterMovementInfo_AnimInput_h_Statics::ScriptStructInfo),
		nullptr, 0);
